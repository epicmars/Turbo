...
import com.androidpi.turbo.base.utils.BitmapUtils;
import com.androidpi.turbo.base.utils.ColorUtils;
            ...
            public void run() {
                if (!isStatusBarSettled && hasFocus) {
                    ...
                    if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.M) {
                        ...
                        BitmapUtils.createBitmapFromView(view, window, rect, new BitmapUtils.BitmapCreateCallback() {
                            @Override
